...
class listener implements EventSubscriberInterface
{
	...
	public function show_idea($event)
	{
		...
		if ($mod)
		{
			$this->template->assign_var('STATUS_ARY', factory::$statuses);
		...
		$can_vote = (bool) ($idea['idea_status'] != factory::$statuses['IMPLEMENTED'] &&
			$idea['idea_status'] != factory::$statuses['DUPLICATE'] &&
