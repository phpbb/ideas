...
$db->sql_query('CREATE TABLE  ' . $table_prefix . 'ideas_comments (
...
{
	$db->sql_query(<<<EOT
INSERT INTO {$table_prefix}ideas_ideas (idea_id, idea_author, idea_title, idea_desc, idea_date, idea_rating, idea_votes, idea_status, bbcode_bitfield, bbcode_uid, bbcode_options) VALUES
...
EOT
	...
	$db->sql_query('INSERT INTO ' . $table_prefix . 'ideas_votes (idea_id, user_id, value) VALUES (1,1,5),(1,2,5),(2,1,5),(2,2,3),(3,1,5),(3,2,5),(3,3,5),(3,4,5);');
}
